...
class ActivityGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Activity entity")
        ...
        .repeat(2) {
            ...
            .post("/api/activities")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "actName":"SAMPLE_TEXT", "actDate":"2020-01-01T00:00:00.000Z", "actPlayercount":"0", "actPrice1":null, "actPrice2":null, "actDesc":"SAMPLE_TEXT", "actContact":"SAMPLE_TEXT", "actContactPhone":"SAMPLE_TEXT", "actStatus":"SAMPLE_TEXT", "actImage":"SAMPLE_TEXT", "actFlag":"SAMPLE_TEXT", "actQrkey":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
